...
public class SplashActivity extends BaseActivity<SplashViewModel, ActivitySplashBinding> {
    ...
    private void loadQuestion() {
        ...
        if (DataUtils.getInstance().getRiasec() == null) {
            DataUtils.getInstance().setRiasec(viewModel.readDataNeo(this, Define.Question.TYPE_RIASEC));
        }
        if (DataUtils.getInstance().getPsychological() == null) {
            DataUtils.getInstance().setPsychological(viewModel.readDataNeo(this, Define.Question.TYPE_PSY_POCHOLIGICAL));
        }
        openWorkingScreen();
    }
